...
Field::Field(uint16_t id, uint8_t size, QWidget *parent) : QPushButton(parent), _FieldID(id), _FieldSize(size), _FieldnearMines(-1), _FieldIsMarked(false), _FieldIsQuestionable(false)
{
